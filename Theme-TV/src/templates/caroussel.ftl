  ...
  <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <#list entries as curEntry>
        ...
        <#assign chamada = docXml.valueOf("//dynamic-element[@name='CampoDeTexto76268907']/dynamic-content[@language-id='pt_BR']/text()") />
        <#--  pegar a imagem da notica  -->
        <#assign FotoXml= docXml.valueOf("//dynamic-element[@name='Imagem64019196']/dynamic-content[@language-id='pt_BR']/text()") />
